if CLIENT then
	...
	hook.Add('Think', 'mwLib.vehicleChanged', function()
...
if SERVER then
	hook.Add('PlayerEnteredVehicle', 'mwLib.vehicleChanged', function(ply, veh, role)
		netstream.Start(nil, 'vehicleChanged', ply, veh, nil)
	end)

	hook.Add('PlayerLeaveVehicle', 'mwLib.vehicleChanged', function(ply, veh)
