...
hook.Add('Think', 'mwLib.pon.init', function()
	hook.Remove('Think', 'mwLib.pon.init')

	pon.queueEntsFlush = mwLib.func.debounce(function()
...
hook.Add('OnEntityCreated', 'mwLib.netVar', entCreated)
hook.Add('NetworkEntityCreated', 'mwLib.netVar', entCreated)

hook.Add('EntityRemoved', 'mwLib.netVar', function(ent)
	local id = ent:EntIndex()
	pon.pendingEnts[id] = nil
end)
